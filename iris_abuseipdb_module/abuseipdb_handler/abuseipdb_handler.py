...
class AbuseipdbHandler(object):
    ...
    def _inner_import_files(self, import_list: list, data_type):
        ...
        if data_type == "<TODO>":
            ...
            # Do your stuff here
            # Example :
            # self.abuseipdb.process_evidence(in_path, out_path)
            self.log.info("<TODO> abuseipdb import")
            ret_t = True
    ...
    def import_evidence(self):
        ...
        self.log.info("Received new abuseipdb import signal for {}".format(self.case_name))
